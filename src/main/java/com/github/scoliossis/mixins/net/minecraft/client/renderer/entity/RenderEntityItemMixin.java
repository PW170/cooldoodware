...
import com.github.scoliossis.modules.impl.render.ItemPhysics;
    ...
    private int func_177077_a(EntityItem itemIn, double p_177077_2_, double p_177077_4_, double p_177077_6_, float p_177077_8_, IBakedModel p_177077_9_) {
        ...
        if (item == null) {
            ...
            if (flag || this.renderManager.options != null) {
                ...
                if (itemPhysics) {
                    if (itemIn.onGround) {
                        double var = ((itemIn.posX + (itemIn.motionX * com.github.scoliossis.utils.minecraft.TimerUtil.getTickDelta())) * 200) + ((itemIn.posZ + (itemIn.motionZ * com.github.scoliossis.utils.minecraft.TimerUtil.getTickDelta())) * 200);
                        ...
                        double x = (itemIn.posX + (itemIn.motionX * com.github.scoliossis.utils.minecraft.TimerUtil.getTickDelta())) * 200;
                        double y = (itemIn.posY + (itemIn.motionY * com.github.scoliossis.utils.minecraft.TimerUtil.getTickDelta())) * 200;
                        double z = (itemIn.posZ + (itemIn.motionZ * com.github.scoliossis.utils.minecraft.TimerUtil.getTickDelta())) * 200;
