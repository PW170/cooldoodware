...
public class ColourModuleRenderer extends SubModuleRenderer {
    private static final int DISPLAY_COLOR_SIZE = 12;
    ...
    public void render(int mouseX, int mouseY, SubModule subModule) {
        ...
        // Colour swatch (rounded square)
        float swatchX = ClickGUIScreen.BASE_X + ClickGUIScreen.GUI_TAB_WIDTH
                - ClickGUIScreen.PANEL_PADDING - 4 - DISPLAY_COLOR_SIZE - 4;
        float swatchY = ClickGUIScreen.BASE_Y + SUBMODULE_HEIGHT / 2f - DISPLAY_COLOR_SIZE / 2f;
        RenderUtil.drawRoundedRect(swatchX, swatchY, DISPLAY_COLOR_SIZE, DISPLAY_COLOR_SIZE, 3, currentColour);
        RenderUtil.drawRoundedRectOutline(swatchX, swatchY, DISPLAY_COLOR_SIZE, DISPLAY_COLOR_SIZE, 3, 1, ClickGUIScreen.COL_RIM_HIGHLIGHT);
        ...
        RenderUtil.drawRoundedRectOutline(csX - 1, BOTTOM_GAP - 1, COLOUR_SQUARE_SIZE + 2, COLOUR_SQUARE_SIZE + 2, 3, 1, ClickGUIScreen.COL_RIM_HIGHLIGHT);
        ...
        RenderUtil.drawRoundedRectOutline(csX, 0, COLOUR_SQUARE_SIZE, SLIDERS_HEIGHT, 2, 1, ClickGUIScreen.COL_RIM_HIGHLIGHT);

        int hueThumbX = MathHelper.clamp_int((int)(subModule.colorSettingValues.hueValue * COLOUR_SQUARE_SIZE) - 3, 0, COLOUR_SQUARE_SIZE - 6);
        RenderUtil.drawRoundedRect(csX + hueThumbX, -1, 6, SLIDERS_HEIGHT + 2, 3, Color.WHITE);
        ...
        RenderUtil.drawRoundedRect(csX + alphaThumbX, -1, 6, SLIDERS_HEIGHT + 2, 3, Color.WHITE);
