...
public class SubCategoryRenderer extends SubModuleRenderer {
    ...
    public void render(int mouseX, int mouseY, SubModule subModule) {
        ...
        RenderUtil.drawRoundedRect(cardX, ClickGUIScreen.BASE_Y, cardW, SUBMODULE_HEIGHT,
                ClickGUIScreen.SUBMOD_RADIUS,
                new Color(45, 45, 58, 255));

        // Left accent mark
        RenderUtil.drawRoundedRect(cardX, ClickGUIScreen.BASE_Y + 3, 3,
                SUBMODULE_HEIGHT - 6, 2,
                new Color(catColor.getRed(), catColor.getGreen(), catColor.getBlue(), 160));
